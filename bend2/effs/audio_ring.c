...
// rest of its buffer with silence. audio_open.c, audio_write.c and
// audio_close.c pull this file through // @src so any one of the three
// still compiles alone, and a program that imports more than one
// still sees a single copy.
#ifndef IO_RING
